...
class TestHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    # Capture fixtures assert this MIME type. Keep it stable across base-image
    # updates: the system MIME database may label WAV files audio/vnd.wave.
    extensions_map = {**SimpleHTTPRequestHandler.extensions_map, '.wav': 'audio/x-wav'}

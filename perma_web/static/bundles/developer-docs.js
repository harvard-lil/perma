...
function RealTypeOf(v) {
  if ((0,_babel_runtime_corejs3_helpers_typeof__WEBPACK_IMPORTED_MODULE_0__["default"])(v) == "object") {
  ...
  return (0,_babel_runtime_corejs3_helpers_typeof__WEBPACK_IMPORTED_MODULE_0__["default"])(v);
}
  ...
  $.each(oData, function (sKey, vValue) {
    ...
    switch (RealTypeOf(vValue)) {
      ...
      case "string":
        ...
        break;
      default:
        sHTML += "TYPEOF: " + (0,_babel_runtime_corejs3_helpers_typeof__WEBPACK_IMPORTED_MODULE_0__["default"])(vValue);
    }
...
$(document).ready(function () {
  $(".prettyprint").each(function () {
    try {
      var str = core_js_pure_stable_json_parse_js__WEBPACK_IMPORTED_MODULE_1___default()($(this).text());

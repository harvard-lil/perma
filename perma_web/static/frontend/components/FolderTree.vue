...
<template>
  <div class="panel-heading">
    Folders
    <span class="buttons">
      <a href="#" class="float-end delete-folder icon-trash" aria-label="Delete Selected Folder"
         title="Delete Selected Folder" @click.prevent="deleteFolder"></a>
      <a href="#" class="float-end edit-folder icon-edit" aria-label="Rename Selected Folder"
         title="Rename Selected Folder" @click.prevent="editFolder"></a>
      <a href="#" class="float-end new-folder icon-plus" aria-label="New Folder" title="New Folder"

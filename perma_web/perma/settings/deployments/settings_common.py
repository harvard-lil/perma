...
# List of mirrors to push updates to.
# Each entry is a dict with the 'address' to send an HTTP poke to, and optional 'headers'.
# Example:
# MIRRORS = [{'address':'mirrordomain.com'},{'address':'12.34.56.78',{'headers':{'Host':'mirrordomain2.com'}}}]
MIRRORS = []

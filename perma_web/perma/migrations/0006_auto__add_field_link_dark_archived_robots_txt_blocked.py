...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.dark_archived_robots_txt_blocked'
        db.add_column(u'perma_link', 'dark_archived_robots_txt_blocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.dark_archived_robots_txt_blocked'
        db.delete_column(u'perma_link', 'dark_archived_robots_txt_blocked')

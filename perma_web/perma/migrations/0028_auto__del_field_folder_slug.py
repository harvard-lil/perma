...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Folder.slug'
        db.delete_column(u'perma_folder', 'slug')


    def backwards(self, orm):
        # Adding field 'Folder.slug'
        db.add_column(u'perma_folder', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='slug', max_length=255),
                      keep_default=False)

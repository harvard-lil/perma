...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VestingOrg'
        db.create_table(u'perma_vestingorg', (
        ...
        db.send_create_signal(u'perma', ['VestingOrg'])

        # Adding field 'LinkUser.vesting_org'
        db.add_column(u'perma_linkuser', 'vesting_org',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['perma.VestingOrg'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VestingOrg'
        db.delete_table(u'perma_vestingorg')

        # Deleting field 'LinkUser.vesting_org'
        db.delete_column(u'perma_linkuser', 'vesting_org_id')

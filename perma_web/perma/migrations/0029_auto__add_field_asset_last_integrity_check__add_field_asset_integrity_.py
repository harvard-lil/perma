...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.last_integrity_check'
        db.add_column(u'perma_asset', 'last_integrity_check',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Asset.integrity_check_succeeded'
        db.add_column(u'perma_asset', 'integrity_check_succeeded',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.last_integrity_check'
        db.delete_column(u'perma_asset', 'last_integrity_check')

        # Deleting field 'Asset.integrity_check_succeeded'
        db.delete_column(u'perma_asset', 'integrity_check_succeeded')
    ...
    models = {
        u'perma.asset': {
            ...
            'integrity_check_succeeded': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'perma_linkuser_groups'))


    def backwards(self, orm):
        # Adding M2M table for field groups on 'LinkUser'
        m2m_table_name = db.shorten_name(u'perma_linkuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('linkuser', models.ForeignKey(orm[u'perma.linkuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['linkuser_id', 'group_id'])
    ...
    models = {
        ...
        u'perma.linkuser': {
            ...
            'registrar': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['perma.Registrar']", 'null': 'True', 'blank': 'True'}),

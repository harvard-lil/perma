...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Stat'
        db.create_table(u'perma_stat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('regular_user_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('vesting_member_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('vesting_manager_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('registrar_member_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('registry_member_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('registrar_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('unvested_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('vested_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('global_uniques', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('disk_usage', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
        db.send_create_signal(u'perma', ['Stat'])


    def backwards(self, orm):
        # Deleting model 'Stat'
        db.delete_table(u'perma_stat')

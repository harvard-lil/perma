...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stat.vesting_org_count'
        db.add_column(u'perma_stat', 'vesting_org_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stat.vesting_org_count'
        db.delete_column(u'perma_stat', 'vesting_org_count')

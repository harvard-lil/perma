...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.user_deleted'
        db.add_column(u'perma_link', 'user_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Link.user_deleted_timestamp'
        db.add_column(u'perma_link', 'user_deleted_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.user_deleted'
        db.delete_column(u'perma_link', 'user_deleted')

        # Deleting field 'Link.user_deleted_timestamp'
        db.delete_column(u'perma_link', 'user_deleted_timestamp')

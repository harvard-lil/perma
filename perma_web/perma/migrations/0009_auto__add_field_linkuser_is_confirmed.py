...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinkUser.is_confirmed'
        db.add_column(u'perma_linkuser', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinkUser.is_confirmed'
        db.delete_column(u'perma_linkuser', 'is_confirmed')

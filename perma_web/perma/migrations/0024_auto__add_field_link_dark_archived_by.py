...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.dark_archived_by'
        db.add_column(u'perma_link', 'dark_archived_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='darchived_links', null=True, to=orm['perma.LinkUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.dark_archived_by'
        db.delete_column(u'perma_link', 'dark_archived_by_id')

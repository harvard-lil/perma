...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Folder'
        db.create_table(u'perma_folder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['perma.Folder'])),
            ('creation_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='folders_created', null=True, to=orm['perma.LinkUser'])),
        ...
        db.create_table(u'perma_link_folders', (
            ...
            ('link', models.ForeignKey(orm[u'perma.link'], null=False)),
            ('folder', models.ForeignKey(orm[u'perma.folder'], null=False))
        ))
        db.create_unique(u'perma_link_folders', ['link_id', 'folder_id'])

...
urlpatterns = patterns('perma.views',
    ...
    url(r'^manage/vesting-users/(?P<user_id>[a-zA-Z0-9]+)/remove/(?P<vesting_org_id>[a-zA-Z0-9]+)/?$', 'user_management.manage_single_vesting_user_remove', name='user_management_manage_single_vesting_user_remove'),

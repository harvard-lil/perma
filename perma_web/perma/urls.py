...
urlpatterns = patterns('perma.views',
    ...
    url(r'^manage/journal-managers/?$', 'user_management.manage_vesting_manager', name='user_management_manage_vesting_manager'),
    url(r'^manage/journal-managers/(?P<user_id>[a-zA-Z0-9]+)/?$', 'user_management.manage_single_vesting_manager', name='user_management_manage_single_vesting_manager'),
    url(r'^manage/journal-managers/(?P<user_id>[a-zA-Z0-9]+)/delete/?$', 'user_management.manage_single_vesting_manager_delete', name='user_management_manage_single_vesting_manager_delete'),
    url(r'^manage/journal-managers/(?P<user_id>[a-zA-Z0-9]+)/reactivate/?$', 'user_management.manage_single_vesting_manager_reactivate', name='user_management_manage_single_vesting_manager_reactivate'),
    url(r'^manage/journal-members/?$', 'user_management.manage_vesting_member', name='user_management_manage_vesting_member'),
    url(r'^manage/journal-members/(?P<user_id>[a-zA-Z0-9]+)/?$', 'user_management.manage_single_vesting_member', name='user_management_manage_single_vesting_member'),
    url(r'^manage/journal-members/(?P<user_id>[a-zA-Z0-9]+)/delete/?$', 'user_management.manage_single_vesting_member_delete', name='user_management_manage_single_vesting_member_delete'),
    url(r'^manage/journal-members/(?P<user_id>[a-zA-Z0-9]+)/reactivate/?$', 'user_management.manage_single_vesting_member_reactivate', name='user_management_manage_single_vesting_member_reactivate'),
    url(r'^manage/created-links(?P<path>/.*)?$', 'user_management.created_links', name='user_management_created_links'),
    url(r'^manage/vested-links(?P<path>/.*)?$', 'user_management.vested_links', name='user_management_vested_links'),
